    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraIngredientOrders", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ExtraIngredientOrders_ExtraIngredients_ExtraIngredientID",
                        column: x => x.ExtraIngredientID,
                        principalTable: "ExtraIngredients",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraIngredientOrders_Orders_OrderID",
                        column: x => x.OrderID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraIngredientOrders_ExtraIngredientID",
                table: "ExtraIngredientOrders",
                column: "ExtraIngredientID");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraIngredientOrders_OrderID",
                table: "ExtraIngredientOrders",
                column: "OrderID");

            migrationBuilder.CreateIndex(
                name: "IX_MenuOrders_AppUserID",
                table: "MenuOrders",
                column: "AppUserID");
